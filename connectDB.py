...
def addDialog(dialogList, dialog_id, speaker_id, content, time, session_id, prompt_phase, task):

    mydict = {'Dialog_id': dialog_id, 'Speaker_id': speaker_id, 'Content': content, 'Phase': prompt_phase, 'Task': task,
