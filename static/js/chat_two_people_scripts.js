...
if(userData){
  ...
  console.log("URL", url)
  roomID = url.pathname.replace("/chats_two_people/", "");
...
function clear_chatbot() {
    document.getElementById("chatbot_head_id").style.visibility = "hidden";
    document.getElementById("chatbotsay").style.visibility = "hidden"; 
}
...
var user = { "lastSeenTime" : "", "character" : "no_chatbot" , "player" : 2,  "User_id": classID + userID, "partner": getPartner()}; 
var chatbotWords = [];
